...
import 'package:e_commerce_app/controller/bevegares_controller.dart';
import 'package:get/get.dart';

class BevegaresPage extends StatelessWidget {
  BevegaresPage({super.key});

  final BevegaresController bevegaresController = Get.put(
    BevegaresController(),
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: GetBuilder<BevegaresController>(
          builder: (controller) {
            return Padding(
